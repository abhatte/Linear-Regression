...
states.data <- readRDS("/Users/ashwinibhatte/Documents/Data Science/linear_regression/dataSets/states.rds") #get labels

states.info <- data.frame(attributes(states.data)[c(
  "names", "var.labels")])#look at last few labels
...
sts.ex.sat <- subset(states.data, select = c(
  "expense", "csat"))
